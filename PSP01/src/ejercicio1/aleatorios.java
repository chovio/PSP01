...
public class aleatorios {
	...
	public static void main(String[] args) {
		...
		/*
		 * Utilizamos el propio array de la clase main para la entrada de datos
		 * ya que lo haremos por consola y es muy útil. 
		 * Al ejecutar por comando tendremos que poner el parámetro que indique 
		 * el número de veces que queremos que se generen los aleatorios
		 * 
		 */
		
		if(args.length == 1 && args[0].matches("\\d\\d*")) { //Si el dato introducido en el parámetro sólo ocupa 1, y es un dígito, entonces

...
public class Lenguaje {
	...
	public static void main(String[] args) throws IOException {
		...
		//
		// convierte a caracter un número de 0 a 26 sumado al valor de "a" que por tanto
		// será el comienzo.
		// Los char tienen su equivalente numérico.
		// Es decir, si 'a' le sumamos 0, nos devolverá 'a'. Si le sumamos 1 'b', y
		// suscesivamente hasta la z.

		// Qué nos pide el ejercicio?

		// Ejecutar 'java ejercicio2.Lenguaje 40 miFicheroDeLenguaje.txt', por tanto hay
		// que pasar dos parámetros
		...
		if (args.length == 2 && args[0].matches("\\d+")) {
			...
			try {
				...
				for (int i = 0; i < limiteRepeticiones; i++) {// repetir hasta llegar al número de repeticiones
																// indicadas
